...
"use strict";
const levelRender = function(canvas, player, platforms, background, boundaries) {
...
class Game {
  ...
  render() {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__util_levelRender__["a" /* default */])(this.canvas, this.player, this.platforms, this.background, this.boundaries);
  }
}
