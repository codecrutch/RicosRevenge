...
document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log((0, _scoreboard2.default)("rico", 0));
  ...
  _createClass(Game, [{
    ...
    value: function render() {
      ...
      if (!this.gameover) {
        ...
        (0, _scoreboard2.default)("rico", this.score);
        console.log(document.cookie);
        console.log((0, _scoreboard2.default)("rico", this.score));
...
function updateScoreboard(username, score) {
    var oldScore = getCookie(username);
...
exports.default = updateScoreboard;
