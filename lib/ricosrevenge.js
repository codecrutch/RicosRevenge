...
document.addEventListener("DOMContentLoaded", () => {
  ...
  heightPos = 375;
  for (var i = 0; i < platformLength; i++) {
     platforms.push(new __WEBPACK_IMPORTED_MODULE_0__object__["a" /* default */]("assets/platform50.png", startPos += 48, heightPos, 35, 5));
  }
  ...
  heightPos = 460;
  for (var i = 0; i < platformLength; i++) {
     platforms.push(new __WEBPACK_IMPORTED_MODULE_0__object__["a" /* default */]("assets/platform50.png", startPos += 48, heightPos, 1, 1));
  }
  ...
  heightPos = 460;
  for (var i = 0; i < platformLength; i++) {
     platforms.push(new __WEBPACK_IMPORTED_MODULE_0__object__["a" /* default */]("assets/platform50.png", startPos += 48, heightPos, 5, 1));
  }
 ...
 // bottom platform
  ...
  heightPos = 530;
  for (var i = 0; i < platformLength; i++) {
     platforms.push(new __WEBPACK_IMPORTED_MODULE_0__object__["a" /* default */]("assets/platform50.png", startPos += 48, heightPos, 20, 1));
  }
