  ...
  _createClass(Player, [{
    ...
    value: function update() {
      ...
      if (this.Y > 540) {
        ...
        setTimeout(function () {
          _this2.Y = -100, _this2.game.background.X = 0, _this2.game.platforms = _this2.game.level.getPlatforms(), _this2.gravity = 500, _this2.weight = 2, _this2.addKeyboardEvents();
        }, 1000);
      }
