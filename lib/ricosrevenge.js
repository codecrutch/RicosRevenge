...
class LevelOne {
  ...
  drawBoundaries() { 
    this.generateBoundary(70, 210, 75, 100)
  }
  ...
  update(platforms,background,level) {
    ...
    if (this.Y > 540) {
      ...
      setTimeout(() => {
        ...
        this.game.boundaries = level.getBoundaries(),
        this.gravity = 500,
        this.weight = 2,
...
class Game {
  ...
  render() {
    ...
    this.enemies.forEach(enemy => {enemy.X += -this.player.Velocity_X; enemy.update(); console.log(enemy.X)});
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__util_levelRender__["a" /* default */])(this.canvas, this.player, this.platforms, this.background, this.boundaries, this.enemies);
  }
}
